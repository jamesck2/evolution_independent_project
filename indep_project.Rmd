...
```{r}
# 2008
lmm_shoot_2008 <- lmer(sqrt(shootmass) ~ nitrogen + (1|harvester) + (1|strain) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2008"))
Anova(lmm_shoot_2008, type = 3)

# full model minus strain random effect
lmm_shoot_2008_dplot <- lmer(sqrt(shootmass) ~ nitrogen + (1|harvester) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2008"))
...
```{r}
# 2018
lmm_shoot_2018 <- lmer(sqrt(shootmass) ~  nitrogen + (1|harvester) + (1|strain) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2018"))
Anova(lmm_shoot_2018, type = 3)

# full model minus strain random effect
lmm_shoot_2018_dplot <- lmer(sqrt(shootmass) ~ nitrogen + (1|harvester) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2018"))
...
# Control
# full model with all random effects
lmm_nod_0N <- lmer(sqrt(nodulenum) ~ plantspori + dataset_year + plantspori:dataset_year + (1|harvester) + (1|strain) + (1|harvestdate), data = metadata %>%  filter(nitrogen=="Control"))
Anova(lmm_nod_0N, type = 3)
summary(lmm_nod_0N)
