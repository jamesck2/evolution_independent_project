...
```{r}
lmm_shoot_2008 <- lmer(shootmass ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2008"))
summary(lmm_shoot_2008)
Anova(lmm_shoot_2008, type = 3) # nitrogen has sig effect, make plot
plot(lmm_shoot_2008)

lmm_shoot_2018 <- lmer(shootmass ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2018"))
summary(lmm_shoot_2018)
Anova(lmm_shoot_2018, type = 3) # nothing is sig
plot(lmm_shoot_2018)

lmm_chloro_2008 <- lmer(log(chloro) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2008"))
summary(lmm_chloro_2008)
Anova(lmm_chloro_2008, type = 3) # nitrogen has sig effect, make plot
plot(lmm_chloro_2008)

lmm_chloro_2018 <- lmer(log(chloro) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2018"))
...
lmm_nodulenum_2008 <- lmer(sqrt(nodulenum) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2008"))
summary(lmm_nodulenum_2008)
Anova(lmm_nodulenum_2008, type = 3) # nothing is sig
plot(lmm_nodulenum_2008)

lmm_nodulenum_2018 <- lmer(sqrt(nodulenum) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2018"))
summary(lmm_nodulenum_2018)
Anova(lmm_nodulenum_2018, type = 3) # nothing is sig
plot(lmm_nodulenum_2018)

lmm_meannodulemass_2008 <- lmer(sqrt(meannodulemass) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2008"))
summary(lmm_meannodulemass_2008)
Anova(lmm_meannodulemass_2008, type = 3)  # nothing is sig
plot(lmm_meannodulemass_2008)

lmm_meannodulemass_2018 <- lmer(sqrt(meannodulemass) ~ plantspori + nitrogen + plantspori:nitrogen + (1|strain) + (1|harvestdate), data = metadata %>% filter(dataset_year=="2018"))
...
```{r}
# 2008
lmm_chloro_2008 <- lmer(sqrt(chloro) ~ nitrogen + leafnum + (1|harvester) + (1|strain) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2008"))
Anova(lmm_chloro_2008, type = 3)

# full model minus strain random effect
lmm_chloro_2008_dplot <- lmer(sqrt(chloro) ~ nitrogen + leafnum + (1|harvester) + (1|harvestdate), data = metadata %>%  filter(dataset_year == "2008"))
...
# Control
# full model with all random effects
lmm_nod_0N <- lmer(sqrt(nodulenum) ~ plantspori + nitrogen + plantspori:dataset_year + (1|harvester) + (1|strain) + (1|harvestdate), data = metadata %>%  filter(nitrogen=="Control"))
Anova(lmm_nod_0N, type = 3)
summary(lmm_nod_0N)
